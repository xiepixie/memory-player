                ...
                components={{
                    ...
                    code: ({ className, children, ...props }) => {
                        ...
                        if (lang && lang.startsWith('math-cloze-')) {
                            ...
                            // Maintain occurrence index per cloze ID, same as #cloze- links
                            ...
                            const uniqueKey = `${numId}-${occurrenceIndex}`;

                            const handleClick = (e: any) => {
                                if (!onClozeClick || Number.isNaN(numId)) return;
                                e.preventDefault();
                                e.stopPropagation();
                                onClozeClick(numId, occurrenceIndex, e.currentTarget as HTMLElement);
                            };

                            const handleContextMenu = (e: any) => {
                                if (!onClozeContextMenu || Number.isNaN(numId)) return;
                                e.preventDefault();
                                e.stopPropagation();
                                onClozeContextMenu(numId, occurrenceIndex, e.currentTarget as HTMLElement, e);
                            };
                            ...
                            return (
                                <span
                                    ...
                                    onClick={onClozeClick ? handleClick : undefined}
                                    onContextMenu={onClozeContextMenu ? handleContextMenu : undefined}
                                >
                                    <MathClozeBlock
